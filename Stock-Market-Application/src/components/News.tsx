        ...
        <div className="col-lg-12 card-control-section basic_card_layout">
          <div className="e-card-resize-container">
            <div className="row">
              <div className="row card-layout">
                <div className="col-xs-4 col-sm-4 col-lg-4 col-md-4">
                  <div className="e-card card1" id="basic_card">
                ...
                <div className="col-xs-4 col-sm-4 col-lg-4 col-md-4">
                  <div className="e-card card2" id="weather_card">
                    <div className="e-card-header">
                      <div className="e-card-header-caption">
                        <div className="e-card-header-title">
                ...
                <div className="col-xs-4 col-sm-4 col-lg-4 col-md-4">
                  <div className="e-card card3" id="weather_card">
                    <div className="e-card-header">
                      <div className="e-card-header-caption">
                        <div className="e-card-header-title">
            ...
            <div className="row">
              <div className="row card-layout">
                <div className="col-xs-4 col-sm-4 col-lg-4 col-md-4">
                  <div className="e-card card4" id="basic_card">
                    <div className="e-card-header">
                      <div className="e-card-header-caption">
                        <div className="e-card-header-title">
                ...
                <div className="col-xs-4 col-sm-4 col-lg-4 col-md-4">
                  <div className="e-card card5" id="weather_card">
                    <div className="e-card-header">
                      <div className="e-card-header-caption">
                        <div className="e-card-header-title">
                ...
                <div className="col-xs-4 col-sm-4 col-lg-4 col-md-4">
                  <div className="e-card card6" id="basic_card">
                    <div className="e-card-header">
                      <div className="e-card-header-caption">
                        <div className="e-card-header-title">
